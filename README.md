...
- 👤 **Клиентский кабинет** (`/`) — регистрация/вход, **сброс пароля по e-mail**,
  создание конфигов, копирование полей и скачивание файла, ссылки на **приложения
  TrustTunnel** (iOS/Android/PC). Без лимитов, баланса и тарифов.
